 ...
 */
public class LwmaAggregatorTest {
    private static final double TOL = 1.0E-06;
    private static final String JSON1 = "/json/agg/lwma-agg-1.json";
    private static final String JSON2 = "/json/agg/lwma-agg-2.json";
    private static final String JSON3 = "/json/agg/lwma-agg-3.json";
    ...
    public void testApply() {
        ...
        Assert.assertEquals(agg2.apply(vec3), 3.666667, TOL);
        Assert.assertEquals(agg3.apply(vec3), 2.619048, TOL);

        // No missing values...
        Assert.assertEquals(agg1.apply(vec4), 4.333333, TOL);
        Assert.assertEquals(agg2.apply(vec4), 4.333333, TOL);
        Assert.assertEquals(agg3.apply(vec4), 4.333333, TOL);
    }
    ...
    public void testJSON() {
        ...
        var agg1E = new LwmaAggregator(6, true, nan1E);
        var agg2E = new LwmaAggregator(6, true, nan2E);
        var agg3E = new LwmaAggregator(6, true, nan3E);
