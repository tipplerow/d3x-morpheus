...
public class MaxTest {
    ...
    public void testOfVector() {
        assertTrue(Double.isNaN(Max.of(D3xVector.copyOf())));
        assertEquals(Max.of(D3xVector.copyOf(1.0)), 1.0, TOLERANCE);
        assertEquals(Max.of(D3xVector.copyOf(1.0, 4.0, 33.0, 4.0)), 33.0, TOLERANCE);
    }
}
