 ...
 */
public class BiweightKernelTest extends RealDistributionTestBase {
    private static final int SAMPLE_SIZE = 1000000;
    private static final double TOLERANCE = 1.0E-06;
    private static final BiweightKernel dist = BiweightKernel.INSTANCE;

    private final double[] sample = dist.sample(random(), SAMPLE_SIZE);

    public BiweightKernelTest() {
        super(TOLERANCE);
    }
    ...
    public void testMoments() {
        runMomentTest(dist, sample, 0.002, true);
    }

    @Test
    public void testQuantile() {
        runQuantileTest(dist, TOLERANCE);
    }
}
