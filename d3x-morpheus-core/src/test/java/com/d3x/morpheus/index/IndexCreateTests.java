...
public class IndexCreateTests {
    ...
    public <T> void testCreateByIterable1(Array<T> array) {
        ...
        for (int i=0; i<index.size(); ++i) {
            ...
            Assert.assertEquals(index.getCoordinate(key), i, "Index matches for ordinal " + i);
            Assert.assertEquals(index.getOrdinal(key), i, "Ordinals match");
            Assert.assertEquals(index.getCoordinateAt(i), i, "Ordinal and index match");
        }
    }
    ...
    public <T> void testCreateByIterable3(Array<T> array) {
        ...
        for (int i=0; i<index2.size(); ++i) {
            ...
            Assert.assertEquals(index2.getCoordinate(key), index1.getCoordinate(key), "Index matches for ordinal " + i);
            Assert.assertEquals(index2.getOrdinal(key), index1.getOrdinal(key), "Ordinals match");
            Assert.assertEquals(index2.getCoordinateAt(i), index1.getCoordinateAt(i), "Ordinal and index match");
        }
    }
    ...
    public <T> void testCreateByIterable4(Array<T> array) {
        ...
        for (int i=0; i<index1.size(); ++i) {
            ...
            Assert.assertEquals(index1.getCoordinate(key), i, "Index matches for ordinal " + i);
            Assert.assertEquals(index1.getOrdinal(key), i, "Ordinals match");
            Assert.assertEquals(index1.getCoordinateAt(i), i, "Ordinal and index match");
            Assert.assertEquals(index2.getCoordinate(key), index1.getCoordinate(key), "Index matches for ordinal " + i);
            Assert.assertEquals(index2.getOrdinal(key), index1.getOrdinal(key), "Ordinals match");
            Assert.assertEquals(index2.getCoordinateAt(i), index1.getCoordinateAt(i), "Ordinal and index match");
        }
