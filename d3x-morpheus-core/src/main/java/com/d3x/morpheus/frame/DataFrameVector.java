...
public interface DataFrameVector<X,Y,R,C,Z> extends DataFrameOperations<R,C,Z>, DataFrameIterators<R,C>, Iterable<DataFrameValue<R,C>> {
     ...
     * @return      the value for key
     */
    boolean getBooleanAt(int ordinal);
     ...
     * @return          the previous value
     */
    boolean setBooleanAt(int ordinal, boolean value);
     ...
     * @return          the previous value
     */
    int setIntAt(int ordinal, int value);
     ...
     * @return          the previous value
     */
    long setLongAt(int ordinal, long value);
     ...
     * @return          the previous value
     */
    double setDoubleAt(int ordinal, double value);
