...
public interface DataFrameValue<R,C> extends Comparable<DataFrameValue<R,C>> {
    ...
    /**
     * Returns true if this value contains a null value
     * @return  true if value is null
     */
    boolean isNull();

    /**
     * Returns true if this value contains a non-null value
    ...
    /**
     * Returns true if this value holds a String type
     * @return  true if holds a String type
     */
    boolean isString();

    /**
     * Returns true if this value holds a Date type
     * @return  true if holds a Date type
     */
    boolean isDate();

    /**
     * Returns true if this value holds a LocalDate type
     * @return  true if holds a LocalDate type
     */
    boolean isLocalDate();
