...
public class MultiCharts {
    ...
    public void smallImages() throws Exception {
        ...
        charts.forEach(chart -> {
            chart.legend().bottom();
            chart.options().withPreferredSize(width, height);
            chart.writerPng(new File(String.format("../morpheus-docs/docs/images/gallery/chart-%s.png", counter.incrementAndGet())), width, height, true);
        });
    }
