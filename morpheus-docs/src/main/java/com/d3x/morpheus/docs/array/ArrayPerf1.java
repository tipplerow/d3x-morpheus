...
public class ArrayPerf1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String key : callableMap.keySet()) {
            ...
            initTimes.rows().setDouble(key, 0, perfStat.getCallTime(StatType.MEDIAN));
            gcTimes.rows().setDouble(key, 0, perfStat.getGcTime(StatType.MEDIAN));
            memory.rows().setDouble(key, 0, perfStat.getUsedMemory(StatType.MEDIAN));
        }
