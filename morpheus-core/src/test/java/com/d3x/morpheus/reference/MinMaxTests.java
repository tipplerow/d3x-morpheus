...
public class MinMaxTests {
    ...
    public void testMin() {
        ...
        Optional<DataFrameValue<Integer,Integer>> result0 = frame.min(v -> true);
        Assert.assertTrue(result0.isPresent());
        Assert.assertEquals(result0.get().getInt(), 1);

        Optional<DataFrameValue<Integer,Integer>> result1 = frame.transpose().min(v -> true);
    ...
    public void testMax() {
        ...
        Optional<DataFrameValue<Integer,Integer>> result0 = frame.max(v -> true);
        Assert.assertTrue(result0.isPresent());
        Assert.assertEquals(result0.get().getInt(), 100);

        Optional<DataFrameValue<Integer,Integer>> result1 = frame.transpose().max(v -> true);
        Assert.assertTrue(result1.isPresent());
    ...
    public void testMinWithPredicate2(boolean parallel) {
        ...
        Assert.assertTrue(result0.isPresent());
        Assert.assertEquals(result0.get().getDouble(), expected[0]);
        ...
        Assert.assertTrue(result1.isPresent());
        Assert.assertEquals(result1.get().getDouble(), expected[0]);
    }
    ...
    public void testMaxWithPredicate2(boolean parallel) {
        ...
        Assert.assertEquals(result.get().getDouble(), expected[0]);
    ...
    public void testArgMinForRow(boolean parallel) {
        ...
        match.ifPresent(v -> {
            ...
            final double minActual = frame.getDoubleAt(5, v.colOrdinal());
    ...
    public void testArgMinForColumn(boolean parallel) {
        ...
        match.ifPresent(v -> {
            ...
            final double minActual = frame.getDoubleAt(v.rowOrdinal(), 5);
            assertEquals(minActual, minExpected, 0.00001);
        });
    }
    ...
    public void testArgMaxForColumn(boolean parallel) {
        ...
        match.ifPresent(v -> {
            ...
            final double actual = frame.getDoubleAt(v.rowOrdinal(), 5);
